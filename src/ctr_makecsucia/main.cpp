...
static const Crypto::sRsa2048Key es_tmd_key =
{
...
static const Crypto::sAes128Key commkey[6] =
{
...
static const u8 es_commonkey_dev[6][0x10] =
{
	{ 0x55, 0xA3, 0xF8, 0x72, 0xBD, 0xC8, 0x0C, 0x55, 0x5A, 0x65, 0x43, 0x81, 0x13, 0x9E, 0x15, 0x3B } , // 0 - eShop Titles
	{ 0x44, 0x34, 0xED, 0x14, 0x82, 0x0C, 0xA1, 0xEB, 0xAB, 0x82, 0xC1, 0x6E, 0x7B, 0xEF, 0x0C, 0x25 } , // 1 - System Titles
	{ 0xF6, 0x2E, 0x3F, 0x95, 0x8E, 0x28, 0xA2, 0x1F, 0x28, 0x9E, 0xEC, 0x71, 0xA8, 0x66, 0x29, 0xDC } , // 2
...
// certs
static const u8 es_ca_cert[0x400] =
{
...
static const u8 es_tik_cert[0x300] =
{
...
static const u8 es_tmd_cert[0x300] =
{
...
void ReplaceFileExtention(std::string& path, const std::string& new_extention)
{
